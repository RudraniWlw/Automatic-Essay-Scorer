...
def index():
    ...
    if request.method == 'POST':
        saved_essay = request.form.get('essay', '')
        
        if saved_essay and len(saved_essay) > 10:
            features = vectorizer.transform([clean_essay(saved_essay)])
    ...
    <div class="box">
        <h1>📰 Essay Scorer</h1>
        <form method="POST">
            <textarea name="essay" placeholder="Paste your essay here...">{saved_essay}</textarea>
